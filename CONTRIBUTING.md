# Contributing to Rolo

Check existing [issues](https://github.com/hintheshell/rolo/issues) and
[pull requests](https://github.com/hintheshell/rolo/pulls) first.
...
- **No bloat.** Rolo stays small on purpose — quality over quantity. A clean patch still gets
...
- `open Tinycast.xcodeproj` → ⌘R. Debug builds are their own channel (`Rolo Dev.app`).
...
macOS version, Rolo version, steps, expected vs actual. A recording beats a paragraph.
