...
enum UpdateFailure: LocalizedError, Equatable {
    ...
    var errorDescription: String? {
        ...
        case .noAppInArchive:
            return "The downloaded archive does not contain Rolo."
        case .quarantined:
            return "macOS quarantined the downloaded app and Rolo could not clear the flag."
        case .bundleMismatch:
            return "The downloaded app is not this build of Rolo."
        case .identityMismatch:
        ...
        case .replaceFailed(let detail):
            return "Rolo could not be replaced. \(detail)"
        }
    }
